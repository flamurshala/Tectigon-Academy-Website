...
function payment_row_to_response(array $row): array
{
    return [
        ...
        'bank_status' => $row['payment_bank_status'] ?? $row['bank_status'] ?? null,
        'order_bank_status' => $row['bank_status'] ?? null,
        'hpp_redirect_url' => $row['hpp_redirect_url'] ?? null,
        'raw_create_order_response' => $row['raw_create_order_response'] ?? null,
        'raw_get_order_response' => $row['raw_get_order_response'] ?? null,
...
function payment_select_sql(): string
{
    return 'SELECT
        ...
        o.payment_provider,
        o.bank_order_id,
        o.bank_order_password,
        o.bank_hpp_url,
        o.bank_status,
        o.hpp_redirect_url,
        o.raw_create_order_response,
        o.raw_get_order_response,
        o.notes,
        p.provider_payment_id,
        p.provider_transaction_id,
        p.approval_code,
        p.bank_status AS payment_bank_status,
        p.raw_response,
        o.created_at,
        o.updated_at,
        p.paid_at,
